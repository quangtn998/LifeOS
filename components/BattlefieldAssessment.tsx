...
interface BattlefieldAssessmentProps {
  ...
  onAssessmentChange: (field: keyof QuestAssessment, value: string) => void;
}

const BattlefieldAssessment: React.FC<BattlefieldAssessmentProps> = ({
  quest,
  assessment,
  onAssessmentChange,
}) => {
  ...
  const isWork = quest.category === 'work';
...
interface FieldProps {
  assessment: QuestAssessment | null;
  onChange: (field: keyof QuestAssessment, value: string) => void;
}
...
export default BattlefieldAssessment;
