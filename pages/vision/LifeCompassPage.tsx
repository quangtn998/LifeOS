    ...
    <div className="space-y-8">
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                <Card><h2 className="font-bold">The Eulogy Method</h2><p className="text-sm text-gray-400 mt-1">What do you want people to say about you at the end of your life? What do you want people to say about you at the end of your life?What do you want people to say about you at the end of your life?What do you want people to say about you at the end of your life?What do you want people to say about you at the end of your life?What do you want people to say about you at the end of your life?What do you want people to say about you at the end of your life?What do you want people to say about you at the end of your life?What do you want people to say about you at the end of your life?</p><textarea value={data.eulogy} onChange={e => handleChange('eulogy', e.target.value)} rows={8} className="w-full p-2 mt-2 text-white bg-gray-900 border-gray-700 rounded-md"/></Card>
